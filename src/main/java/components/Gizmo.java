...
public class Gizmo extends Component {
    ...
    public void editorUpdate(float dt) {
        ...
        if (this.activeGameObject != null) {
            ...
            if (KeyListener.isKeyPressed(NOVA_KEY_LEFT_CONTROL) &&
                    KeyListener.keyBeginPress(NOVA_KEY_D)) {
                ...
                return;
            } else if (KeyListener.keyBeginPress(NOVA_KEY_DELETE)) {
